...
$conn = mysqli_connect("localhost", "root", "", "restaurant");
  ...
  $sql = "SELECT ORD_ID,ITEM_ID,MOB,QUANTITY,ITEM_RATE,TOTAL FROM orders";
  ...
  if ($result->num_rows > 0)
   ...
   while($row = $result->fetch_assoc())
    {
  echo "<tr><td>" . $row["ORD_ID"]. "</td><td>" .$row["ITEM_ID"]."</td><td>" .$row["MOB"].  "</td><td>" .$row["QUANTITY"]. "</td><td>".$row["ITEM_RATE"]. "</td><td>" .$row["TOTAL"]. "</td></tr>";
    }
    echo "</table>";
